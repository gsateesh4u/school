...
app.controller('admission',function($scope, $http, $filter) {
					...
					$scope.init = function() {
						...
						$http(
								{
									method : 'POST',
									url : "StateController?action=list",
									datatype : 'text',
									headers : {
										"Content-Type" : "application/x-www-form-urlencoded; charset=UTF-8"
									}
							...
							$scope.cityList = $scope.stateList[0].cityList;
							$scope.selectedCity = $scope.selectedState.cityList[0];
					...
					$scope.validateInfo = function(){
						...
						else if((homeno && homeno.match("^[0-9]{10}$") == null) || (fhomeno && fhomeno.match("^[0-9]{10}$") == null)){
							// homeno.match("^\(\d{3}\) ?\d{3}( |-)?\d{4}|^\d{3}( |-)?\d{3}( |-)?\d{4}")
							alert(homeno);
							$scope.alertMsg("Phone Number Format Not Valid");
						}
						else if(pincode && pincode.match("^[0-9]{6}$") == null){
							$scope.alertMsg("Pincode does not valid");
						}
						else if((email && email.match(validate) == null) || (femail && femail.match(validate) == null) || (memail && memail.match(validate) == null)){
							...
							<form role="form" name="myForm" novalidate>
								...
								<div class="span4">
									...
									<div class="span12">
                                        ...
                                        <div class="span2">
											<label for="textfield" class="form-control">Middle Name </label>
										</div>

										<div class="span4">
											<input placeholder="Enter Middle Name" class="span6 m-wrap h30"
												ng-model="admit.person.middleName" data-rule-required="true"
												type="text">
										</div>
									...
									<div class="span12">
										...
										<div class="span2">
											<label for="textfield" class="form-control"> Section:</label>
										</div>

										<div class="span4">
											<select ng-options="shift for shift in ['A','B','C','D','E','F']"
												ng-init="admit.student.batch='A'"
									...
									<div class="span12">
										...
										<div class="span4">
											<input placeholder="Enter AadharNumber" class="span6 m-wrap h30"
												ng-model="admit.person.aadharNumber" 
												type="text">
										</div>
										<div class="span2">
											<label for="textfield" class="form-control">Academic Year </label>
										</div>

										<div class="span4">
										<select ng-model="admit.student.academicYear"
												...
												ng-init="admit.student.academicYear='2017'">
									...
									<div class="span12">
										...
										<div class="span4">
											...
											<input ng-model="admit.student.nationality"
                                             ...
                                             <select ng-model="admit.student.nationality" class='span6 m-wrap h30'
												id="nationality"
												ng-options="nationality for nationality in ['Indian','American']"
												ng-init="admit.student.nationality='Indian'">
								...
								<div class="span12">
									...
									<div class="span2">
											<label for="textfield" class="form-control">Home Phone
											 <span style="color:red;">*</span></label>
									</div>
								...
								<div class="span12">
									...
									<div class="span2">
										<label for="textfield" class="form-control">State</label>
									</div>
									<div class="span4">
									...
									<div class="span4">
										<select class="span6 m-wrap h30"
											...
											ng-model="selectedCity" data-rule-required="true">
										</select>
									</div>
