					...
					<div ng-hide="true" id="printData">
						<table width="604" height="460" border="1">
						  <tr>
						    ...
						    <td colspan="2"><h1><strong>Siva Sivani High School</strong></h1></td>
						  </tr>
						  <tr>
						    <td colspan="3">Marripalem, Visakhapatnam, Andhra Pradesh 530009, India.</td>
						  </tr>
						  <tr>
						    <td colspan="2">phone:079-30429522</td>
						    <td width="289">Email:info@sivasivanihighschool.in</td>
						  </tr>
						  <tr>
						  ...
						  <tr>
						    <td height="23" colspan="3"><div align="center">Website : www.sivasivanihighschool.in</div></td>
						  </tr>
						</table>
					</div>
