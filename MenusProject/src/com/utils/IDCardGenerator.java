...
public class IDCardGenerator {
   ...
   /* public static void main(String[] args) throws IOException, DocumentException {
    ...
    public PdfPTable getTable(Person per, Student s, Person mother, Person father) throws IOException {
        ...
        sb.append("<table>");
        sb.append("<tr>");
        sb.append("<th colspan=\"3\">Siva Sivani School</th>");
        sb.append("</tr>");
		
		sb.append("<tr>");
		//sb.append("<td colspan=\"2\"> Gr No :" + s.getGrNo());
			//sb.append("</td>");
			sb.append("<td rowspan=\"6\"><img src='"+per.getPhoto()+"' height=\"150px\" width=\"117px\"/>");
			sb.append("</td>");
		sb.append("</tr>");
		...
		sb.append("<tr>");
		sb.append("<td colspan=\"2\"> Standard: "+s.getStandardId());
		sb.append("</td>");
	sb.append("</tr>");
		...
		sb.append("<tr>");
			sb.append("<td colspan=\"3\"> School Address: Marripalem, Visakhapatnam, Andhra Pradesh 530009, India");
			sb.append("</td>");
		sb.append("</tr>");
        sb.append("</table>");
